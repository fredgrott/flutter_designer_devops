...
class MaybeTooltip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return condition && message != null && message != '' ? Tooltip(message: message ?? '', padding: padding, margin: margin, verticalOffset: verticalOffset, preferBelow: preferBelow, child: child) : child;
  }
}
